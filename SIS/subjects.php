...
<head>
    ...
    <title>Subjects - Harvard University SIS</title>
    ...
    <div class="layout">
        <nav class="sidebar" role="navigation" aria-label="Main menu">
            ...
            <ul class="menu">
                ...
                <li class="active"><a href="subjects.php" aria-current="page"><i class="fas fa-book"></i> Subjects</a></li>
